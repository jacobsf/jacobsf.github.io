!function () {
    ...
    Calendar.prototype.drawFreddiehead = function () {
        var self = this;
        if (!this.freddiehead) {
            //Create the freddiehead elements
            this.freddiehead = createElement('div', 'freddiehead');
            this.freddiehead.className = 'freddiehead';
            ...
            //Append the Elements
            this.freddiehead.appendChild(this.title);
            this.freddiehead.appendChild(right);
            this.freddiehead.appendChild(left);
            this.el.appendChild(this.freddiehead);
        }
